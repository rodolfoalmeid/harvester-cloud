...
|------|-------------|------|---------|:--------:|
| <a name="input_azure_subscription"></a> [azure\_subscription](#input\_azure\_subscription) | Specifies the Azure subscription where objects will be created | `string` | `null` | no |
...
| <a name="input_region"></a> [region](#input\_region) | Specifies the Azure region used for all resources. Default is 'eastus'. | `string` | `"eastus"` | no |
