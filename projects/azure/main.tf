locals {
  ...
  instance_type = (
    var.harvester_node_count == 1 ? (var.harvester_cluster_size == "small" ? "Standard_D16s_v5" : "Standard_D32s_v5") :
    var.harvester_node_count == 3 ? (var.harvester_cluster_size == "small" ? "Standard_D32s_v5" : "Standard_D64s_v5") :
    "Standard_D64s_v5"
  )
}
